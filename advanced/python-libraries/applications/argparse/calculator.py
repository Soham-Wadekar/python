...
def compute(n1, n2, op):
    match op:
        ...
        case "div": return n1 / n2 if n2 != 0 else "Invalid!"
        case "f_div": return n1 // n2
        case "exp": return n1 ** n2
...
# Operations
parser.add_argument('--operation', help="Select the operation to perform"
                    , type=str, choices=operations, default='add')
parser.add_argument('-r', '--reverse', help='Reverses the order of the operands',
                    action='store_true')
